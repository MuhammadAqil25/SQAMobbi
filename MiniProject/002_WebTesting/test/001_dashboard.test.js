...
describe('Mizan Store Dashboard Web Testing', function() {
    ...
    // describe('Click Blog on Navbar', function() {
    //     it('Go to Blog Page', async function() {
    //         await dashboardPage.openPage()
    //         await dashboardPage.clickNavBar(5)
    //         const url = await driver.getCurrentUrl()
    //         expect(url).to.equal('https://blog.mizanstore.com/')
    //     })
    // })
    ...
    describe('Click Product Buku Terbaru', function() {
        ...
        it('Go to Product Detail 12 Page', async function() {
            ...
            const url = await driver.getCurrentUrl()
            expect(url).to.equal('https://mizanstore.com/racun_puan_72461')
        }) 
    })
