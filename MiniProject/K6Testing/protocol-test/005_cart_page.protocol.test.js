...
const pageDuration = new Trend('page_cart_with_1_item_duration', true)


export default function () {
	group('005_cart_page_with_1_Item', function () {
		const responses = http.batch([
			...
			['GET', 'https://mizanstore.com/assets/dist/voucher-v1.css', headers],
