...
export default function () {
	group('003_detailProduct_page', function () {
		const responses = http.batch([
			['GET', 'https://mizanstore.com/percy_jackson_and_the_72513', headers],
			['GET', 'https://mizanstore.com/assets/dist/produkdetail.v2.css', headers],
			...
			['GET', 'https://mizanstore.com/assets/bower_components/jquery-ui/ui/widgets/datepicker.js', headers],
			['GET', 'https://mizanstore.com/assets/plugins/tumbelina/thumbelina.js', headers],
			['GET', 'https://mizanstore.com/assets/plugins/rateyo/jquery.rateyo.min.js', headers],
			...
			['GET', 'https://mizanstore.com/cart_catalog/test_adi/f_GetNilaiStar/72513', headers],
			['GET', 'https://mizanstore.com/cart_catalog/Ctrl_api_produk/list_produk_kat/', headers],
			['GET', 'https://mizanstore.com/cart_catalog/Ctrl_api_produk/list_produk/2736', headers],
			...
			['GET', 'https://mizanstore.com/themes/book-store/images/bx_loader.gif', headers],
